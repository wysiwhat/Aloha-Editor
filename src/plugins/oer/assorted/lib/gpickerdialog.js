...
function VideoPickerCallback(data) {
    if(data.action == google.picker.Action.PICKED){
        ...
        // var embed_code_template = Aloha.jQuery('<div class="multimedia-video"><iframe width="640" height="360" src="" wmode="transparent" frameborder="0" allowfullscreen></iframe></div>');
