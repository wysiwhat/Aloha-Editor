...
function VideoPickerCallback(data) {
    if(data.action == google.picker.Action.PICKED){
        ...
        var embed_code_template = Aloha.jQuery('<div style="width:640; height=360" class="multimedia-video"><iframe width="640" height="360" src="" wmode="transparent" frameborder="0" allowfullscreen></iframe></div>');
        ...
        var embed_code = Aloha.jQuery(embed_code_template).find('iframe').attr('src', embed_url);
