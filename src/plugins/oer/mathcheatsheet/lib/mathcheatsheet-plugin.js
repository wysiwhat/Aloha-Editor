...
(function() {
  define(['aloha', 'aloha/plugin', 'jquery', 'css!mathcheatsheet/css/mathcheatsheet.css'], function(Aloha, Plugin, $) {
    return Plugin.create("mathcheatsheet", {
      ...
      init: function() {
        ...
        Aloha.require(['math/math-plugin'], function(MathPlugin) {
          ...
          return MathPlugin.editor.find('.math-help-link span').on('click', function(e) {
            var $h, HELP_TEMPLATE;
