...
//        formatAbbr, insertAbbr, abbrText
    define(["aloha", "aloha/plugin", "ui/ui", '../../appmenu/appmenu',
        "i18n!format/nls/i18n", "i18n!aloha/nls/i18n", "aloha/console",
        "css!simpletoolbar/css/simpletoolbar.css"], function (Aloha, Plugin, Ui, appmenu, i18n, i18nCore) {
        ...
        return Plugin.create("simpletoolbar", {
            dependencies:['undo'],
            init:function () {
                var applyHeading, item, labels, menu, menuLookup, /*menubar,*/ order, recurse,
                    subMenuItems, tab, toolbar, toolbarLookup, _i, _j, _len, _len2;
